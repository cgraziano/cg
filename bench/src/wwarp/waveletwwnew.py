...
def goSinopec1():
  ...
  #Wavelet estimation parameters
  nb,kb = 81,-41#sampling for inverse wavelet A #Note ka<=kc 
  nc,kc = 81,-41# sampling for wavelet H 
  nd,kd = nc,kc# sampling for wavelet H 
  ...
  [allRes2NormSqInitS,dataRes2NormSqInitS,bPenaltyRes2NormSqInitS,cPenaltyRes2NormSqInitS],\
  color=None,\
  vlabel=["allRes","dataRes","bPenRes","cPenRes"],\
  vminmax=[None,None,None,None],\
  vint=[None,None,None,None],\
  hlabel="Iterations",hminmax=[0,lastIter],hint=None,\
  title=title,pngDir=pngDir,\
  slide=None,fracWidth=None,fracHeight=None,\
  paper=True,onecol=True,twocol=False)
  ...
  siter = Sampling(niter,1.0,0.0)
  plotting.plotMeasOnTopOfEachOther(siter,
  [allRes2NormSqFinaS,dataRes2NormSqFinaS,bPenaltyRes2NormSqFinaS,cPenaltyRes2NormSqFinaS],\
  color=None,\
  vlabel=["allRes","dataRes","bPenRes","cPenRes"],\
  vminmax=[None,None,None,None],\
  vint=[None,None,None,None],\
