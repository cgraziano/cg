...
from wwarp import WaveletWarpingCBGN, WaveletWarpingHA, Warper
...
def oneDNoNoiseHighSqueezingTwoWavelets():
  directory = "./slides/nonoiseHighSqueezing/"
  #Synthetic parameters
...
def goSinopecSimple():
  #directory = "./slides/oldMethod0/"
  directory = "./slides/oldMethod3/"
  #directory = "./slides/oldMethod5/"
  #directory = "./slides/oldMethod10/"
  #get sino images
  x0,nx = 0,721
  f,gNoNR,u = getSinoImage(x0,nx)
  ...
  hw =  ww.getWaveletC(nc,kc,nb,kb,bone,hstabfact,u,f,g)
  cguess = copy(hw)
  cbw = ww.getWaveletHInverseA(nb,kb,bguess,nc,kc,cguess,u,f,g,niter)
  #Estimated Wavelets
  cw = cbw[0]
  bw = cbw[1]
  ...
  hsg = ww.applyH(nc,kc,hw,warp.applyS(u,ww.applyH(nb,kb,bone,g)))
  ...
  title = "All Rms Residuals"
  maxrmsri = max(allResRmsAllS)#0.15
  minrmsrf = allResRmsAllS[lastIter+1]#0.0
  siter = Sampling(niter,1.0,0.0)
  color=[Color.BLACK,Color.RED]
  vlabel,vminmax,vint = "RMS of all residuals",[minrmsrf,maxrmsri],None
  hlabel,hminmax,hint = "Iterations",[0.0,lastIter+1],None
