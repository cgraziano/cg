...
def impulseConstantSqueezing():
  ...
  ampspec.plotAmplitudeSpectrum(stq,q,0,nq,simplePlot,forSlide,forPrint,pngDir,"amp q",fracWidth,fracHeight,aspectRatio);
...
def estimateOneWavelet2t():
 ...
 #Plotting
  ...
  hint = None
  st = Sampling(nc,dt,kc*dti)
  plotting.plotWavelets(st,[nhw],hint=hint,hsize=hsize,vsize=vsize,linestyle=lineStyle,title=title,pngDir=pngDir,paper=True,twocol=True)
...
def estimateTwoWaveletsCycliclnt():
 ...
 #Plotting
  ...
  print "All RMS"
  dump(allResRmsAllS)
  print "length = "+str(len(allResRmsAllS))
  ...
  ndguess = normalizeMAAWOS(dguess)
  dump(ncw)
  dti = dt
  ...
  ndguess = interpolate(nd,kc,ndguess,dt,nc2,dt2,error,freq)
  nc = nc2
  #nb = nb2
  dt = dt2
  #"""
  ...
  hint = None
  st = Sampling(nc,dt,kc*dti)
  plotting.plotWavelets(st,[ncguess],hint=hint,hsize=hsize,vsize=vsize,linestyle=lineStyle,title=title,pngDir=pngDir,paper=True,twocol=True)
  ...
  ndguess[160] = 1.0
  plotting.plotWavelets(st,[ndguess],hint=hint,hsize=hsize,vsize=vsize,linestyle=lineStyle,title=title,pngDir=pngDir,paper=True,twocol=True)
...
def estimateTwoWaveletsGNlnt():
 ...
 #Plotting
  ...
  nbwBeforePenalization = normalizeMAAWOS(bwBeforePenalization)
  ndwBeforePenalization = normalizeMAAWOS(dwBeforePenalization)
  ncwAfterPenalization = normalizeMAAWOS(cwAfterPenalization)
  nbwAfterPenalization = normalizeMAAWOS(bwAfterPenalization)
  ...
  nbwBeforePenalization = interpolate(nb,kb,nbwBeforePenalization,dt,nb2,dt2,error,freq)
  ...
  nbwAfterPenalization = interpolate(nb,kb,nbwAfterPenalization,dt,nb2,dt2,error,freq)
  ncguess = interpolate(nc,kc,ncguess,dt,nc2,dt2,error,freq)
  ndguess = interpolate(nd,kc,ndguess,dt,nc2,dt2,error,freq)
  nc = nc2
  nb = nb2
  ...
  hint = None
  st = Sampling(nc,dt,kc*dti)
  plotting.plotWavelets(st,[ncwBeforePenalization],hint=hint,hsize=hsize,vsize=vsize,linestyle=lineStyle,title=title,pngDir=pngDir,paper=True,twocol=True)
  ...
  hint = None
  st = Sampling(nc,dt,kc*dti)
  plotting.plotWavelets(st,[ndwBeforePenalization],hint=hint,hsize=hsize,vsize=vsize,linestyle=lineStyle,title=title,pngDir=pngDir,paper=True,twocol=True)
  ...
  hint = None
  st = Sampling(nc,dt,kc*dti)
  plotting.plotWavelets(st,[ncwAfterPenalization],hint=hint,hsize=hsize,vsize=vsize,linestyle=lineStyle,title=title,pngDir=pngDir,paper=True,twocol=True)
  ...
  hint = None
  st = Sampling(nc,dt,kc*dti)
  plotting.plotWavelets(st,[ndwAfterPenalization],hint=hint,hsize=hsize,vsize=vsize,linestyle=lineStyle,title=title,pngDir=pngDir,paper=True,twocol=True)
...
def increaseBy1CyclicNoise():
  ...
  maxrms = 0.15#max([max(allRmsResCB),max(allRmsResH)])
...
def goSinopecGN():
  ...
  tilespacing = None
  clip = 3.0
  plotting.plotImagesSideBySide(st,sx,[g,g,bg],\
  vlabel=vlabel,vminmax=vminmax,vint=vint,\
  hlabel=hlabel,hminmax=hminmax,hint=hint,\
  clip = clip,\
  tilespacing = tilespacing,\
  ...
  print "niter = "+str(niter)
  print "rmsLength = "+str(len(allResRmsAllS))
  ...
  ampspec2D.plotAmplitudeSpectrum(stf,f,100,500,simplePlot,forSlide,forPrint,pngDir,"amp2D f GN",fracWidth,fracHeight,aspectRatio);
  ...
  hint = None
  st = Sampling(nc,dt,kc*dti)
  plotting.plotWavelets(st,[ncwBeforePenalization],dotsonsticks=True,hint=hint,hsize=hsize,vsize=vsize,linestyle=lineStyle,title=title,pngDir=pngDir,paper=True,twocol=True)
  ...
  hint = None
  st = Sampling(nb,dt,kb*dti)
  plotting.plotWavelets(st,[nbwBeforePenalization],dotsonsticks=True,hint=hint,hsize=hsize,vsize=vsize,linestyle=lineStyle,title=title,pngDir=pngDir,paper=True,twocol=True)
  ...
  hint = None
  st = Sampling(nc,dt,kc*dti)
  plotting.plotWavelets(st,[ndwBeforePenalization],dotsonsticks=True,hint=hint,hsize=hsize,vsize=vsize,linestyle=lineStyle,title=title,pngDir=pngDir,paper=True,twocol=True)
  ...
  hint = None
  st = Sampling(nc,dt,kc*dti)
  plotting.plotWavelets(st,[ncwAfterPenalization],dotsonsticks=True,hint=hint,hsize=hsize,vsize=vsize,linestyle=lineStyle,title=title,pngDir=pngDir,paper=True,twocol=True)
  ...
  hint = None
  st = Sampling(nb,dt,kb*dti)
  plotting.plotWavelets(st,[nbwAfterPenalization],dotsonsticks=True,hint=hint,hsize=hsize,vsize=vsize,linestyle=lineStyle,title=title,pngDir=pngDir,paper=True,twocol=True)
  ...
  hint = None
  st = Sampling(nc,dt,kc*dti)
  plotting.plotWavelets(st,[ndwAfterPenalization],dotsonsticks=True,hint=hint,hsize=hsize,vsize=vsize,linestyle=lineStyle,title=title,pngDir=pngDir,paper=True,twocol=True)

def goSinopecGNSmallerStoppingCondition():
  #directory = None
  directory = "./thesisFigures/4pt2GNNOStopping/"
  nb,kb = 23,-11#sampling for inverse wavelet A #Note ka<=kc 
  #directory = "./slides/0sinopec/"
  #directory = "./slides/2sinopec/"
  #directory = "./slides/3sinopec/"
...
def goSinopecCyclic():
  ...
  wwrms = WaveletWarpingCBCyclic();
  print "rms of f = "+str(wwrms.rms(0,nt-1,f))
  print "rms of g = "+str(wwrms.rms(0,ng-1,g))
  gain(100,f)
  gain(100,g)
  print "rms of f = "+str(wwrms.rms(0,nt-1,f))
  print "rms of g = "+str(wwrms.rms(0,ng-1,g))
 ...
 #Wavelet estimation parameters
  ...
  nhwLarge = 81
  khwLarge = -40
  hwLarge =  ww.getShapingFilterH(nhwLarge,khwLarge,nb,kb,bone,hstabfact,u,f,g)
  print "beginning h"
  ...
  #large shaping filter
  hLargesg = ww.applyC(nhwLarge,khwLarge,hwLarge,warp.applyS(u,ww.applyC(nb,kb,bone,g)))
  dummybPen = zerofloat(nb)
  dummycPen = zerofloat(nc)
  print "link save zelda" +str(ww.rmsOfObjectiveFunction(sub(f,hLargesg),dummybPen,dummycPen))
