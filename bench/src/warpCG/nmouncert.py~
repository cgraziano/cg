...
def main(args):
  ...
  funcert = 1.0
  luncert = 0.01
  goEstimateWaveletFromGather(args[1],tmin,tmax,funcert,luncert)

def goEstimateWaveletFromGather(name,tmin,tmax,funcert,luncert):
  ...
  for u in range(0,3):
    ...
    na,ka,nh,kh,hsyn,tmin,tmax,uncerts[u],w=w[u])
    #hpef,hnmo = inverseAndWaveletCalc(sx,st,f,vnmo,fmin,fmax,sfac,
