...
public class SegyImage {
    ...
    int i3min, int i3max)
  {
    ...
    try {
      ...
      System.out.println("i2max = "+i2max);
      System.out.println("i3min = "+i3min);
      System.out.println("i3max = "+i3max);
      for (int i3=i3min; i3<=i3max; ++i3) {
        ...
        for (int i2=i2min; i2<=i2max; ++i2) {
          ...
          getTrace(i2,i3,f);
          /*if (i2==i2min+20 && i3==i3min+30) {
            System.out.println("getTraceSgy to dat: f[30][20][1000]:");
            dump(f);
          }*/
          copy(m1,i1min,f,0,g);
          if (s!=1.0f) {
          ...
          if (i2==i2min+20 && i3==i3min+30) {
            System.out.println("writeFloats");
            //System.out.println("Sgy to dat: g[30][20][1000]:");
            //dump(g);
          }
          aos.writeFloats(g);
        }
  ...
  public int[][] getGridIndices() {
    ...
    int[] gridI2s = new int[_ntrace];
    int[] gridI3s = new int[_ntrace];
    try {
    ...
    return new int[][]{gridI2s,gridI3s};
  }
  ...
  private void loadTraceHeaderInfo() {
    ...
    // non-negative trace index can also be used to compute the byte 
    // offset for the corresponding trace in the SEG-Y file.
    System.out.println("_i2max = "+_i2max);
    System.out.println("_i2min = "+_i2min);
    System.out.println("_i3max = "+_i3max);
    System.out.println("_i3min = "+_i3min);
    _n2 = 1+_i2max-_i2min;
    _n3 = 1+_i3max-_i3min;
    _itrace = new int[_n3][_n2];
    for (int i3=0; i3<_n3; ++i3)
