...
foldersDir = "/Users/Chris/Documents/Smoother/"

#Specify the name of .sgy file. Do not include the .sgy extension.
sgyFileName = "3DFXY_PSRADIAL_PPSTRUCT"
...
#Halfwidth of windows in each dimension used to find structure of image.
...
writtenSgyFileName = sgyFileName+"_Written"+"sigma1_"+str(sigma1)+"sigma2_"+str(sigma2)+"sigma3_"+str(sigma3)+"smoothingDegree"+str(smoothingDegree)
...
def main(args):
  ...
  whichDir = smoothDir
  whichDatFileName = smoothFileName
