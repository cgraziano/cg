...
public class MorletFileTestPlot3Frequencies {
	public static void main(String[] args) {
		...
		File fileF1 = new File(
				"C:/Users/Chris/workspace/Harmonic_Attributes/TPMorlet1.dat");
		File fileF2 = new File(
				"C:/Users/Chris/workspace/Harmonic_Attributes/TPMorlet2.dat");
		...
		pf1.setVisible(true);
		pf1.paintToPng(1000, 5, "3Frequencies8RHz21.9GHz60BHz.png");
