...
public class PlotClassData {
	public static void main(String[] args) {
		...
		final Sampling depth = new Sampling(n1, .004f, .6);// in km
		...
		SwingUtilities.invokeLater(new Runnable() {
			public void run() {
				...
				IndexColorModel icmi = cm.getColorModel();
				IndexColorModel icm = cm.setAlpha(icmi, 135);
				...
				pf1.paintToPng(1000, 5, "ClassDataSlideNorm8to60Hz3F4x4som.png");
